...
const dirPath = "/Users/yawdmac/Software_Projects/langchain_db/langtut/files"
...
const directoryLoader = new DirectoryLoader(dirPath, {
    ".pdf": (path) => new PDFLoader(filePath),
...
// Time to retreive form the vector store and print out  the info that I am searching for.
...
const prompt = ChatPromptTemplate.fromMessages([
  ...
  const retrievedDocs5 =await agentExecutor.invoke({
    messages: [new HumanMessage("tell me about the server side of the rtp and explain to moe how it works. Please")],
  });
